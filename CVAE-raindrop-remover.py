...
x = layers.Conv2DTranspose(64, (3, 3), activation='relu', strides=(1, 1), padding='same')(x)
x = layers.Conv2DTranspose(32, (3, 3), activation='relu', strides=(2, 2), padding='same')(x)
x = layers.Conv2DTranspose(32, (3, 3), activation='relu', strides=(1, 1), padding='same')(x)
x = layers.Conv2DTranspose(16, (3, 3), activation='relu', strides=(2, 2), padding='same')(x)
x = layers.Conv2DTranspose(16, (3, 3), activation='relu', strides=(1, 1), padding='same')(x)
x = layers.Conv2DTranspose(8, (3, 3), activation='relu', strides=(1, 1), padding='same')(x)
